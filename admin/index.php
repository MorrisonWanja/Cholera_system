    ...
    <div class="basic-column w-col w-col-3">
        <div class="tag-wrapper">
            <div class="number-card number-card-content1">
                <h1 class="number-card-number">Hospitals</h1>
				<?php $hospitals = $hospital->countHospitals(); ?>
                <a href="hospitals/"><div class="number-card-dollars"><?php echo $hospitals; ?></div></a>
    ...
    <div class="basic-column w-col w-col-3">
        <div class="tag-wrapper">
            <div class="number-card number-card-content2">
                <h1 class="number-card-number">Doctors</h1>
                <?php $doctors = $doctor->countDoctors(); ?>
                <a href="doctors/"><div class="number-card-dollars"><?php echo $doctors; ?></div></a>
                <div class="number-card-divider"></div>
