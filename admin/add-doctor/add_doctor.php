...
if(isset($_POST["add_doc_action"])) {
  ...
  if($err_doc_name == '' && $err_no == ''  && $err_mail == ''  && $err_hospital == ''  && $err_pass == ''  && $err_cpass == '') {
	  
	
   if($_POST["add_doc_action"] == "Add Doctor") {

			
		$doctor->addDoctor($doctor_name,$phone_number,$email,$hospital_id,$password);
